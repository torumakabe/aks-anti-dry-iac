...
- [Terraform](https://www.terraform.io/docs/index.html): 1.11.1
  - hashicorp/azurerm: 4.22.0
  - State store: Local
- [TFLint](https://github.com/terraform-linters/tflint): 0.55.1
  - [azurerm plugin](https://github.com/terraform-linters/tflint-ruleset-azurerm): 0.27.0
- [Azure/kubelogin](https://github.com/Azure/kubelogin): 0.1.7
- Ubuntu: 22.04.5 LTS
