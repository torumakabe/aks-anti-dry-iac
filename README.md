...
- [Terraform](https://www.terraform.io/docs/index.html): 1.11.3
  - hashicorp/azurerm: 4.24.0
  - State store: Local
- [TFLint](https://github.com/terraform-linters/tflint): 0.56.0
  - [azurerm plugin](https://github.com/terraform-linters/tflint-ruleset-azurerm): 0.28.0
- [Azure/kubelogin](https://github.com/Azure/kubelogin): 0.2.7
- Ubuntu: 22.04.5 LTS
