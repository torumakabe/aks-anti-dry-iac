...
- [Terraform](https://www.terraform.io/docs/index.html): 1.2.9
  - hashicorp/azurerm: 3.22.0
  - hashicorp/kubernetes: 2.13
  - State store: Local
- [TFLint](https://github.com/terraform-linters/tflint): 0.40.0
  - azurerm plugin: 0.18.0
- [Flux(v2)](https://fluxcd.io/docs/): 0.33.0
