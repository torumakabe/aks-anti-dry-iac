...
- [Terraform](https://www.terraform.io/docs/index.html): 1.2.0
  - hashicorp/azurerm: 3.7.0
  - hashicorp/kubernetes: 2.11
  - State store: Local
- [TFLint](https://github.com/terraform-linters/tflint): 0.36.2
- [Flux(v2)](https://fluxcd.io/docs/): 0.30.2
